...
% {\bf Please write on these instructions if needed.  However, if you don't write on these instructions, we will save paper by using them again in a future session.  Please use the back of your consent form for general notes and doodles.} 
...
\begin{itemize} 
  ...
  % \item Therefore, \dblbkt{1}the expected number of periods in each match will be 100, but it is possible that there are more or less periods in a given match.
